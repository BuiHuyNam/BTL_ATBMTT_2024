        ...
        <section class="blog-list px-3 py-5 p-md-5">
            <div class="container">
                ...
                if (isset($_POST['timkiem'])) {
                    $tukhoa = $_POST['semail1'];
                }
                $query = "SELECT * FROM tbl_noidung,tbl_danhmuc WHERE tbl_noidung.id_danhMuc=tbl_danhmuc.id_danhMuc 
                        AND tbl_noidung.tenNoiDung LIKE '%" . $tukhoa . "%'";
                $sql = mysqli_query($database, $query);
                ...
                if (mysqli_num_rows($sql) > 0) {
                    ...
                    echo "
                        <h4> Nội dung tìm không tồn tại</h4>
                    ";
                }
